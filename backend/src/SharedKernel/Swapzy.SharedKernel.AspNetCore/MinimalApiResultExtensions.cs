...
public static class MinimalApiResultExtensions
{
    public static IHttpResult ToMinimalApiResult<T>(this Result<T> result) =>
        result.Status switch
        {
            ...
            ResultStatus.Error => Error(result),
    ...
    private static BadRequest<ProblemDetails> Invalid(IArdalisResult result)
    {
    ...
    private static BadRequest<ProblemDetails> Error(IArdalisResult result)
    {
    ...
    private static ProblemHttpResult CriticalError(IArdalisResult result)
    {
        var details = FormatErrorDetails(result.Errors);
    ...
    private static ProblemHttpResult Unavailable(IArdalisResult result)
    {
        var details = FormatErrorDetails(result.Errors);
